...
FILE_JSON_PUBLIC_CONFIG = DIRECTORY_DATA + Path("public_config.json")
...
# DO NOT UNCOMMENT. This is here so I can tell you not to do this -- these files are not required.
